...
namespace CookingBook.Utilities
{
    ...
    { 
        ...
        CookinBookDictionary() 
        {
            ...
            {"PL",new CookingBookLabelNames{Main="Główne", Add="Dodaj", Delete="Usuń", Update="Zaktualizuj", Component="Składnik", Name="Nazwa", Price="Cena", Recipe="Przepis", Window="Okno", Menu="Menu", Action="Akcja"  }},
            {"ENG",new CookingBookLabelNames{Main="Main", Add="Add", Delete="Delete", Update="Update", Component="Component", Name="Name", Price="Price", Recipe="Recipe", Window="Window", Menu="Menu", Action="Action"  }}};
        }
    }
}
